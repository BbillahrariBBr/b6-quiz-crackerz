                    ...
                    <div className="px-7 py-6 bg-indigo-500 rounded">
                        <div className="flex flex-wrap">
                            <div className="w-full md:w-1/2 pt-6 mb-10 md:mb-0">
                                <h3 className="mb-1 text-5xl font-bold text-white">
                                    <span className="text-green-300">{q.data.name}</span>
                                </h3>
                                <p className="mb-8 md:mb-16 text-sm font-medium text-indigo-100">No of questions: {q.data.total}</p>
                                <Link className="flex items-center text-white font-medium" to='/'>
                                    <svg className="mr-1" width="12" height="14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="w-full md:w-1/2 flex items-center">
                                <img className="mx-auto h-48" src={q.data.logo} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
